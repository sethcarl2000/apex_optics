#ifndef create_NPolyArray_fit_H
#define create_NPolyArray_fit_H
...
std::vector<std::pair<const NPoly::NPolyElem*,double>> 
    Get_maximum_element_values(ROOT::RDF::RNode df, const NPoly& poly, const std::vector<std::string>& inputs); 
...
int NPolyArray_fit( const int poly_order,
